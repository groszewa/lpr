...
usage -auto -elapse
set log file fv/dsc_mac_top/rtl_to_g1.log -replace
tclmode
...
read library -statetable -liberty -both  \
	/misc/scratch/ajgrosze/lpr/project/synth/5b/dsc_mac/gscl45nm.lib
...
elaborate design -golden -root dsc_mac_top -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/dsc_mac_top/g1.v.gz
} else {
...
elaborate design -revised -root dsc_mac_top
...
write hier_compare dofile fv/dsc_mac_top/hier_rtl_to_g1.do \
...
run hier_compare fv/dsc_mac_top/hier_rtl_to_g1.do -dynamic_hierarchy
