...
module shift_reg_32b_e (
   ...
   assign si_int = ((~wrap_mode) & (scan_in)) | ((wrap_mode) & (shiftreg[31]));
   assign shiftreg_out = shiftreg[31:28];
   

endmodule // shift_reg_32b_e




module shift_reg_32b_s (
    clk,
	scan_in,
    wrap_mode,
    en,
   ...
   assign si_int = ((~wrap_mode) & (scan_in)) | ((wrap_mode) & (shiftreg[31]));
   assign shiftreg_out = shiftreg[31:30];
   

endmodule // shift_reg_32b_s
...
endmodule // ctr_out_bank_32_e


module ctr_out_bank_32_s (
	clk,
    rst,
    en,                    
    mul_in,
   ...
   wire  [8:0] ctr0,ctr1,ctr2,ctr3,ctr4,ctr5,ctr6,ctr7,ctr8,ctr9,ctr10,ctr11,ctr12,ctr13,ctr14,ctr15,ctr16,ctr17,ctr18,ctr19,ctr20,ctr21,ctr22,ctr23,ctr24,ctr25,ctr26,ctr27,ctr28,ctr29,ctr30,ctr31;
