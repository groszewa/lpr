...
usage -auto -elapse
set log file fv/ctr_out_bank_32/rtl_to_g1.log -replace
tclmode
...
elaborate design -golden -root ctr_out_bank_32 -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/ctr_out_bank_32/g1.v.gz
} else {
...
elaborate design -revised -root ctr_out_bank_32
...
write hier_compare dofile fv/ctr_out_bank_32/hier_rtl_to_g1.do \
...
run hier_compare fv/ctr_out_bank_32/hier_rtl_to_g1.do -dynamic_hierarchy
