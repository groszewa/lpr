...
usage -auto -elapse
set log file fv/pipe_mul_eighth_top/rtl_to_g1.log -replace
tclmode
...
read library -statetable -liberty -both  \
	/misc/scratch/ajgrosze/lpr/project/synth/pipe_mac_eighth_addexp/gscl45nm.lib
...
elaborate design -golden -root pipe_mul_eighth_top -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/pipe_mul_eighth_top/g1.v.gz
} else {
...
elaborate design -revised -root pipe_mul_eighth_top
...
write hier_compare dofile fv/pipe_mul_eighth_top/hier_rtl_to_g1.do \
...
run hier_compare fv/pipe_mul_eighth_top/hier_rtl_to_g1.do -dynamic_hierarchy
