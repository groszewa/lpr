...
usage -auto -elapse
set log file fv/top/rtl_to_g1.log -replace
tclmode
...
read library -statetable -liberty -both  \
	/misc/scratch/ajgrosze/lpr/project/synth/toy/gscl45nm.lib
...
write hier_compare dofile fv/top/hier_rtl_to_g1.do \
...
run hier_compare fv/top/hier_rtl_to_g1.do -dynamic_hierarchy
