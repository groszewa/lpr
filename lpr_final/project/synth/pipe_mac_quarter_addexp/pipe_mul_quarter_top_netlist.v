...
// Verification Directory fv/pipe_mul_quarter_top 

module csa_tree_add_745_40_group_17(in_0, in_1, in_2, in_3, out_0);
  ...
  FAX1 g422(.A (in_2[5]), .B (n_8), .C (n_5), .YC (n_20), .YS (n_21));
  FAX1 g423(.A (in_2[3]), .B (n_6), .C (n_13), .YC (n_18), .YS (n_19));
...
module ctr_out_bank_quarter(clk, rst, en, mul_in, bin_out);
  input clk, rst, en;
  input [3:0] mul_in;
  output [31:0] bin_out;
  wire clk, rst, en;
  ...
  wire [5:0] ctr1;
  wire [3:0] unused;
  wire n_4, n_5, n_6, n_8;
  csa_tree_add_745_40_group_17 csa_tree_add_745_40_groupi(.in_0 (ctr3),
       .in_1 (ctr2), .in_2 (ctr0), .in_3 (ctr1), .out_0 (bin_out[7:0]));
  counter_WIDTH6 stoch2bin_0(.out (ctr0), .clk (clk), .en (n_8), .rst
       (rst), .overflow (unused[0]));
  counter_WIDTH6_1 stoch2bin_1(.out (ctr1), .clk (clk), .en (n_6), .rst
       (rst), .overflow (unused[1]));
  counter_WIDTH6_2 stoch2bin_2(.out (ctr2), .clk (clk), .en (n_5), .rst
       (rst), .overflow (unused[2]));
  counter_WIDTH6_3 stoch2bin_3(.out (ctr3), .clk (clk), .en (n_4), .rst
       (rst), .overflow (unused[3]));
  AND2X1 g29(.A (mul_in[0]), .B (en), .Y (n_8));
  AND2X1 g30(.A (mul_in[1]), .B (en), .Y (n_6));
  AND2X1 g31(.A (mul_in[3]), .B (en), .Y (n_4));
  AND2X1 g32(.A (mul_in[2]), .B (en), .Y (n_5));
endmodule

module pipe_mul_16b_quarter(a, b, y);
  input [3:0] a, b;
  output [3:0] y;
  wire [3:0] a, b;
  wire [3:0] y;
...
module shift_reg_16b_quarter(clk, scan_in, wrap_mode, en, rst,
     shiftreg_out);
  ...
  wire [15:0] shiftreg;
  wire n_0, n_1, n_2, n_3, n_4, n_5, n_6, n_7;
  wire n_8, n_9, n_10, n_11, n_12, n_18, n_19, n_20;
  ...
  DFFSR \shiftreg_reg[5] (.R (n_18), .S (1'b1), .CLK (clk), .D (n_50),
       .Q (shiftreg[5]));
  DFFSR \shiftreg_reg[13] (.R (n_18), .S (1'b1), .CLK (clk), .D (n_49),
       .Q (shiftreg[13]));
  ...
  DFFSR \shiftreg_reg[7] (.R (n_18), .S (1'b1), .CLK (clk), .D (n_46),
       .Q (shiftreg[7]));
  DFFSR \shiftreg_reg[8] (.R (n_18), .S (1'b1), .CLK (clk), .D (n_44),
       .Q (shiftreg[8]));
  ...
  MUX2X1 g67(.A (n_7), .B (n_3), .S (en), .Y (n_43));
  MUX2X1 g68(.A (n_9), .B (n_4), .S (en), .Y (n_42));
  MUX2X1 g69(.A (shiftreg_out[1]), .B (shiftreg_out[0]), .S (n_19), .Y
       (n_41));
  MUX2X1 g70(.A (n_4), .B (n_11), .S (en), .Y (n_40));
  MUX2X1 g71(.A (shiftreg_out[2]), .B (shiftreg_out[1]), .S (n_19), .Y
       (n_39));
  MUX2X1 g72(.A (n_11), .B (n_5), .S (en), .Y (n_38));
  MUX2X1 g73(.A (shiftreg_out[3]), .B (shiftreg_out[2]), .S (n_19), .Y
       (n_37));
  MUX2X1 g74(.A (n_5), .B (n_12), .S (en), .Y (n_36));
  ...
  MUX2X1 g82(.A (n_12), .B (n_7), .S (en), .Y (n_28));
  MUX2X1 g83(.A (n_1), .B (n_10), .S (en), .Y (n_27));
  MUX2X1 g84(.A (n_3), .B (n_2), .S (en), .Y (n_26));
  MUX2X1 g85(.A (n_10), .B (n_6), .S (en), .Y (n_25));
  MUX2X1 g86(.A (n_6), .B (n_8), .S (en), .Y (n_24));
  MUX2X1 g87(.A (n_2), .B (shiftreg_out[0]), .S (en), .Y (n_23));
  MUX2X1 g88(.A (n_8), .B (n_9), .S (en), .Y (n_22));
  MUX2X1 g89(.A (shiftreg_out[3]), .B (scan_in), .S (wrap_mode), .Y
       (n_21));
  ...
  BUFX2 drc_bufs158(.A (shiftreg[10]), .Y (n_3));
  BUFX2 drc_bufs159(.A (shiftreg[12]), .Y (shiftreg_out[0]));
  BUFX2 drc_bufs160(.A (shiftreg[8]), .Y (n_12));
  BUFX2 drc_bufs161(.A (shiftreg[7]), .Y (n_5));
  ...
  BUFX2 drc_bufs168(.A (shiftreg[15]), .Y (shiftreg_out[3]));
  BUFX2 drc_bufs169(.A (shiftreg[14]), .Y (shiftreg_out[2]));
  BUFX2 drc_bufs170(.A (shiftreg[13]), .Y (shiftreg_out[1]));
  BUFX2 drc_bufs171(.A (shiftreg[9]), .Y (n_7));
  BUFX2 drc_bufs172(.A (shiftreg[11]), .Y (n_2));
endmodule

module shift_reg_16b_quarter_1(clk, scan_in, wrap_mode, en, rst,
     shiftreg_out);
  input clk, scan_in, wrap_mode, en, rst;
  output [3:0] shiftreg_out;
  wire clk, scan_in, wrap_mode, en, rst;
...
module pipe_mul_quarter_top(clk, rst, en, output_gate, input_bin_a,
  ...
  ctr_out_bank_quarter dut_ctr_out(.clk (clk), .rst (rst_out), .en
       ...
       bin_out_int}));
  pipe_mul_16b_quarter dut_pipe_mul(.a (sr_out_a[3:0]), .b
       (sr_out_b[3:0]), .y (sr_mul_out[3:0]));
  ...
  prg_4b_1 dut_prg4b_b(.clk (clk), .rst (rst), .en (en), .bin_in
       ...
       (ctr4_overflow_b));
  shift_reg_16b_quarter dut_sr_a(.clk (clk), .scan_in (sn_out_a),
       .wrap_mode (wrap_mode_a), .en (en_sr_a), .rst (rst),
       .shiftreg_out (sr_out_a[3:0]));
  shift_reg_16b_quarter_1 dut_sr_b(.clk (clk), .scan_in (sn_out_b),
