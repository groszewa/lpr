...
usage -auto -elapse
set log file fv/ALU/rtl_to_g1.log -replace
tclmode
...
read library -statetable -liberty -both  \
	/misc/scratch/ajgrosze/lpr/project/test_synth/gscl45nm.lib
...
elaborate design -golden -root ALU -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/ALU/g1.v.gz
} else {
...
elaborate design -revised -root ALU
...
write hier_compare dofile fv/ALU/hier_rtl_to_g1.do \
...
run hier_compare fv/ALU/hier_rtl_to_g1.do -dynamic_hierarchy
