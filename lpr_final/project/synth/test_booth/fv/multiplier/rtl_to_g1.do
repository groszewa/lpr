...
usage -auto -elapse
set log file fv/multiplier/rtl_to_g1.log -replace
tclmode
...
read library -statetable -liberty -both  \
	/misc/scratch/ajgrosze/lpr/project/synth/test_booth/gscl45nm.lib
...
elaborate design -golden -root multiplier -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/multiplier/g1.v.gz
} else {
...
elaborate design -revised -root multiplier
