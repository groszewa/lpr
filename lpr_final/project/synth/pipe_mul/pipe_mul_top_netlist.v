...
module csa_tree_add_433_129_group_97(in_0, in_1, in_2, in_3, in_4,
...
module ctr_out_bank(clk, rst, mul_in, bin_out);
  ...
  wire [3:0] ctr1;
  wire [15:0] unused;
  csa_tree_add_433_129_group_97 csa_tree_add_433_129_groupi(.in_0
...
module shift_reg_16b(clk, scan_in, wrap_mode, en, rst, shiftreg_out);
  ...
  wire n_67, n_68, n_69, n_72;
  DFFSR \shiftreg_out_reg[0] (.R (n_19), .S (1'b1), .CLK (clk), .D
       (n_52), .Q (n_69));
  OAI21X1 g43(.A (n_18), .B (n_21), .C (n_0), .Y (n_52));
  DFFSR \shiftreg_out_reg[10] (.R (n_19), .S (1'b1), .CLK (clk), .D
       (n_30), .Q (n_59));
  DFFSR \shiftreg_out_reg[11] (.R (n_19), .S (1'b1), .CLK (clk), .D
       (n_49), .Q (n_58));
  DFFSR \shiftreg_out_reg[3] (.R (n_19), .S (1'b1), .CLK (clk), .D
       (n_29), .Q (n_66));
  DFFSR \shiftreg_out_reg[4] (.R (n_19), .S (1'b1), .CLK (clk), .D
       (n_51), .Q (n_65));
  DFFSR \shiftreg_out_reg[5] (.R (n_19), .S (1'b1), .CLK (clk), .D
       (n_50), .Q (n_64));
  DFFSR \shiftreg_out_reg[6] (.R (n_19), .S (1'b1), .CLK (clk), .D
       (n_48), .Q (n_63));
  DFFSR \shiftreg_out_reg[12] (.R (n_19), .S (1'b1), .CLK (clk), .D
       (n_47), .Q (n_57));
  DFFSR \shiftreg_out_reg[7] (.R (n_19), .S (1'b1), .CLK (clk), .D
       (n_46), .Q (n_62));
  DFFSR \shiftreg_out_reg[8] (.R (n_19), .S (1'b1), .CLK (clk), .D
       (n_44), .Q (n_61));
  DFFSR \shiftreg_out_reg[13] (.R (n_19), .S (1'b1), .CLK (clk), .D
       (n_45), .Q (n_56));
  DFFSR \shiftreg_out_reg[9] (.R (n_19), .S (1'b1), .CLK (clk), .D
       (n_35), .Q (n_60));
  DFFSR \shiftreg_out_reg[14] (.R (n_19), .S (1'b1), .CLK (clk), .D
       (n_34), .Q (n_55));
  DFFSR \shiftreg_out_reg[15] (.R (n_19), .S (1'b1), .CLK (clk), .D
       (n_33), .Q (n_72));
  DFFSR \shiftreg_out_reg[1] (.R (n_19), .S (1'b1), .CLK (clk), .D
       (n_32), .Q (n_68));
  DFFSR \shiftreg_out_reg[2] (.R (n_19), .S (1'b1), .CLK (clk), .D
       (n_31), .Q (n_67));
  ...
  BUFX2 drc_bufs157(.A (n_72), .Y (shiftreg_out[15]));
  BUFX2 drc_bufs158(.A (n_69), .Y (shiftreg_out[0]));
  BUFX2 drc_bufs159(.A (n_67), .Y (shiftreg_out[2]));
  BUFX2 drc_bufs160(.A (n_56), .Y (shiftreg_out[13]));
  BUFX2 drc_bufs161(.A (n_57), .Y (shiftreg_out[12]));
  BUFX2 drc_bufs162(.A (n_58), .Y (shiftreg_out[11]));
  BUFX2 drc_bufs163(.A (n_59), .Y (shiftreg_out[10]));
  BUFX2 drc_bufs164(.A (n_60), .Y (shiftreg_out[9]));
  BUFX2 drc_bufs165(.A (n_61), .Y (shiftreg_out[8]));
  BUFX2 drc_bufs166(.A (n_62), .Y (shiftreg_out[7]));
  BUFX2 drc_bufs167(.A (n_63), .Y (shiftreg_out[6]));
  BUFX2 drc_bufs168(.A (n_64), .Y (shiftreg_out[5]));
  BUFX2 drc_bufs169(.A (n_65), .Y (shiftreg_out[4]));
  BUFX2 drc_bufs170(.A (n_66), .Y (shiftreg_out[3]));
  BUFX2 drc_bufs171(.A (n_55), .Y (shiftreg_out[14]));
  BUFX2 drc_bufs172(.A (n_68), .Y (shiftreg_out[1]));
endmodule
...
module pipe_mul_top(clk, rst, en, input_bin_a, input_bin_b,
     wrap_mode_a, wrap_mode_b, en_sr_a, en_sr_b, rst_out, bin_out);
  ...
  wire ctr4_overflow_a, ctr4_overflow_b, sn_out_a, sn_out_b;
  ctr_out_bank dut_ctr_out(.clk (clk), .rst (rst_out), .mul_in
       ...
       UNCONNECTED2, UNCONNECTED1, bin_out}));
