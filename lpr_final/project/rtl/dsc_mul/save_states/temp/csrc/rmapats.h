...
extern "C" {
#endif
void  hsM_0_0__dsc_mul_daidir (UB  * pcode, vec32  * I868, U  I801);
void  hsM_0_5__dsc_mul_daidir (UB  * pcode, U  I801);
void  hsM_1_0__dsc_mul_daidir (UB  * pcode, scalar  val);
void  hsM_2_0__dsc_mul_daidir (UB  * pcode, scalar  val);
void  hsM_3_0__dsc_mul_daidir (UB  * pcode, vec32  * I868, U  I801);
void  hsM_3_5__dsc_mul_daidir (UB  * pcode, U  I801);
void  hsM_4_0__dsc_mul_daidir (UB  * pcode, scalar  val);
void  hsM_5_0__dsc_mul_daidir (UB  * pcode, scalar  val);
void  hsM_6_0__dsc_mul_daidir (UB  * pcode, vec32  * I868, U  I801);
void  hsM_7_0__dsc_mul_daidir (UB  * pcode, scalar  val);
void  hsM_8_0__dsc_mul_daidir (UB  * pcode, scalar  val);
void  hsM_9_0__dsc_mul_daidir (UB  * pcode, scalar  val);
void  hsM_10_0__dsc_mul_daidir (UB  * pcode, scalar  val);
void  hsM_11_0__dsc_mul_daidir (UB  * pcode, scalar  val);
void  hsM_12_0__dsc_mul_daidir (UB  * pcode, scalar  val);
void  hsM_13_0__dsc_mul_daidir (UB  * pcode, scalar  val);
void  hsM_14_0__dsc_mul_daidir (UB  * pcode, scalar  val);
void  hsM_15_0__dsc_mul_daidir (UB  * pcode, vec32  * I868, U  I801);
void  hsM_16_0__dsc_mul_daidir (UB  * pcode, scalar  val);
