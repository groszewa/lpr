...
usage -auto -elapse
set log file fv/conv_mac/rtl_to_g1.log -replace
tclmode
...
read library -statetable -liberty -both  \
	/home/ecelrc/students/agroszewski/lpr_final/project/rtl/4b_conv/synth/gscl45nm.lib
...
elaborate design -golden -root conv_mac -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/conv_mac/g1.v.gz
} else {
...
elaborate design -revised -root conv_mac
