...
extern "C" {
#endif
void  hsM_0_0__pipe_mac_daidir (UB  * pcode, vec32  * I868, U  I801);
void  hsM_0_5__pipe_mac_daidir (UB  * pcode, U  I801);
void  hsM_1_0__pipe_mac_daidir (UB  * pcode, scalar  val);
void  hsM_2_0__pipe_mac_daidir (UB  * pcode, scalar  val);
void  hsM_3_0__pipe_mac_daidir (UB  * pcode, vec32  * I868, U  I801);
void  hsM_3_5__pipe_mac_daidir (UB  * pcode, U  I801);
void  hsM_4_0__pipe_mac_daidir (UB  * pcode, scalar  val);
void  hsM_5_0__pipe_mac_daidir (UB  * pcode, scalar  val);
void  hsM_5_5__pipe_mac_daidir (UB  * pcode, UB  val);
void  hsM_6_0__pipe_mac_daidir (UB  * pcode, vec32  * I868, U  I801);
void  hsM_7_0__pipe_mac_daidir (UB  * pcode, scalar  val);
void  hsM_8_0__pipe_mac_daidir (UB  * pcode, scalar  val);
void  hsM_9_0__pipe_mac_daidir (UB  * pcode, vec32  * I868, U  I801);
void  hsM_9_6__pipe_mac_daidir (UB  * pcode, scalar  val, U  I917);
void  hsM_9_7__pipe_mac_daidir (UB  * pcode, vec32  * I1093, U  I917, U  I1102);
void  hsM_9_10__pipe_mac_daidir (UB  * pcode, vec32  * I868);
void  hsM_10_0__pipe_mac_daidir (UB  * pcode, scalar  val);
void  hsM_11_0__pipe_mac_daidir (UB  * pcode, scalar  val);
void  hsM_12_0__pipe_mac_daidir (UB  * pcode, scalar  val);
void  hsM_13_0__pipe_mac_daidir (UB  * pcode, scalar  val);
void  hsM_14_0__pipe_mac_daidir (UB  * pcode, scalar  val);
void  hsM_15_0__pipe_mac_daidir (UB  * pcode, scalar  val);
void  hsM_16_0__pipe_mac_daidir (UB  * pcode, scalar  val);
void  hsM_17_0__pipe_mac_daidir (UB  * pcode, scalar  val);
void  hsM_18_0__pipe_mac_daidir (UB  * pcode, scalar  val);
