...
extern "C" {
#endif
void  hsM_0_0__dsc_mac_daidir (UB  * pcode, scalar  val);
void  hsM_0_5__dsc_mac_daidir (UB  * pcode, UB  val);
void  hsM_1_0__dsc_mac_daidir (UB  * pcode, vec32  * I868, U  I801);
void  hsM_1_5__dsc_mac_daidir (UB  * pcode, U  I801);
void  hsM_2_0__dsc_mac_daidir (UB  * pcode, scalar  val);
void  hsM_3_0__dsc_mac_daidir (UB  * pcode, scalar  val);
void  hsM_3_5__dsc_mac_daidir (UB  * pcode, UB  val);
void  hsM_4_0__dsc_mac_daidir (UB  * pcode, scalar  val);
void  hsM_4_5__dsc_mac_daidir (UB  * pcode, UB  val);
void  hsM_5_0__dsc_mac_daidir (UB  * pcode, scalar  val);
void  hsM_6_0__dsc_mac_daidir (UB  * pcode, scalar  val);
void  hsM_7_0__dsc_mac_daidir (UB  * pcode, scalar  val);
void  hsM_7_5__dsc_mac_daidir (UB  * pcode, UB  val);
void  hsM_8_0__dsc_mac_daidir (UB  * pcode, scalar  val);
void  hsM_9_0__dsc_mac_daidir (UB  * pcode, scalar  val);
void  hsM_9_5__dsc_mac_daidir (UB  * pcode, UB  val);
void  hsM_10_0__dsc_mac_daidir (UB  * pcode, vec32  * I868, U  I801);
void  hsM_10_5__dsc_mac_daidir (UB  * pcode, U  I801);
void  hsM_11_0__dsc_mac_daidir (UB  * pcode, vec32  * I868, U  I801);
